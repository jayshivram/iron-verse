    ...
    >
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto w-full">
        <motion.p
          ...
          className="text-xs uppercase tracking-[0.3em] text-amber-500 font-sans mb-4 sm:mb-6"
        >
        ...
        <motion.h1
          ...
          className="font-display text-[clamp(2.5rem,8vw,6.5rem)] text-ink-50 leading-[1.05] mb-6 sm:mb-8"
        >
        ...
        <motion.p
          ...
          className="font-serif text-base sm:text-xl text-ink-300 mb-8 sm:mb-12 max-w-2xl mx-auto leading-relaxed"
        >
        ...
        >
          <Link to="/books" className="btn-primary text-sm sm:text-base px-6 sm:px-8 py-3 sm:py-3.5 flex items-center gap-2">
            <BookOpen size={18} />
            Read for free
          </Link>
          <Link
            to="/about"
            className="btn-ghost text-sm sm:text-base px-4 sm:px-6 py-3 sm:py-3.5 flex items-center gap-2 text-ink-300 hover:text-ink-50"
          >
            About the poet
            <ArrowRight size={16} />
          </Link>
